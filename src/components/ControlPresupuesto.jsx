...
<form className='w-full flex  justify-center'>
    <div className=' flex flex-col w-[90%] text-xl items-center box-border'>
        ...
        <input type="text" className=' rounded-md bg-gray-100 my-2 w-[100%] p-1 sm:w-full'/>
        <input type="submit" value="Añadir" className='rounded bg-blue-400 text-white w-36 py-0.5 cursor-pointer'/>
    </div>
</form>
